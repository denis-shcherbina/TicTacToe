...
public class GameMenuActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        StartGame = (Button) findViewById(R.id.btn_choice1_offline_menu);
        ...
        StartGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GameMenuActivity.this,GetPlayersNamesActivity.class);
