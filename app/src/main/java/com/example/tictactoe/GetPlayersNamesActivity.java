...
public class GetPlayersNamesActivity extends AppCompatActivity implements View.OnTouchListener {
        ...
        playerTwoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(playerTwoName.getText().toString())) {
                    ...
                    Intent intent = new Intent(GetPlayersNamesActivity.this,ChooseSymbolActivity.class);
